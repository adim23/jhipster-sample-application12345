  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication12345App.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication12345App.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jhipsterSampleApplication12345App.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
