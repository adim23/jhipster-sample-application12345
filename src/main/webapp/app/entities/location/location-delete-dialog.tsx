...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.location.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.location.delete.question" interpolate={{ id: locationEntity.id }}>
