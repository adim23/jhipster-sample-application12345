...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.job.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.job.delete.question" interpolate={{ id: jobEntity.id }}>
