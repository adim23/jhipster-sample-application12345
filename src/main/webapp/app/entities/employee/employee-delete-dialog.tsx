...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
