  ...
  return (
    <div>
      <h2 id="task-heading" data-cy="TaskHeading">
        <Translate contentKey="jhipsterSampleApplication12345App.task.home.title">Tasks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication12345App.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/task/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication12345App.task.home.createLabel">Create new Task</Translate>
          </Link>
        </div>
      </h2>
        ...
        {taskList && taskList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication12345App.task.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="jhipsterSampleApplication12345App.task.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('percentCompleted')}>
            ...
            <tbody>
              {taskList.map((task, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{task.dependsOn ? <Link to={`/task/${task.dependsOn.id}`}>{task.dependsOn.title}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication12345App.task.home.notFound">No Tasks found</Translate>
            </div>
          )
        )}
      </div>
