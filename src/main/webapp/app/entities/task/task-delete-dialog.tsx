...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.task.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.task.delete.question" interpolate={{ id: taskEntity.id }}>
