  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication12345App.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication12345App.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.country.countryName')}
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('jhipsterSampleApplication12345App.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
