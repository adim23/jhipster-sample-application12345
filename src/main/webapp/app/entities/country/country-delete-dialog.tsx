...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.country.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.country.delete.question" interpolate={{ id: countryEntity.id }}>
