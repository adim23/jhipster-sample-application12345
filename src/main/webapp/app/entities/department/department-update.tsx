  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication12345App.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication12345App.department.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('jhipsterSampleApplication12345App.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
