...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.department.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
