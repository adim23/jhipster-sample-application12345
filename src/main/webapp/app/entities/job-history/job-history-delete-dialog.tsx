...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
