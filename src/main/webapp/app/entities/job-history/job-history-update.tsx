  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication12345App.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication12345App.jobHistory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication12345App.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('jhipsterSampleApplication12345App.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('jhipsterSampleApplication12345App.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterSampleApplication12345App.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipsterSampleApplication12345App.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
