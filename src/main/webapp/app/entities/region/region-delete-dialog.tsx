...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication12345App.region.delete.question">
        <Translate contentKey="jhipsterSampleApplication12345App.region.delete.question" interpolate={{ id: regionEntity.id }}>
