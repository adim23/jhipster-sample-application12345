...
public interface EmployeeRepository extends JpaRepository<Employee, Long>, JpaSpecificationExecutor<Employee> {
    ...
    @Query(
        value = "select distinct employee from Employee employee left join fetch employee.manager left join fetch employee.department",
    ...
    @Query("select distinct employee from Employee employee left join fetch employee.manager left join fetch employee.department")
