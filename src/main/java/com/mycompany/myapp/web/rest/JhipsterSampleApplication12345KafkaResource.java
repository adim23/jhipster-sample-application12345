...
@RestController
@RequestMapping("/api/jhipster-sample-application-12345-kafka")
public class JhipsterSampleApplication12345KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplication12345KafkaResource.class);
    ...
    public JhipsterSampleApplication12345KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
