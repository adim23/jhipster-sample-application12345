...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Task.class.getName() + ".dependents");
            createCache(cm, com.mycompany.myapp.domain.Task.class.getName() + ".jobs");
            createCache(cm, com.mycompany.myapp.domain.Files.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Files.class.getName() + ".children");
            ...
            createCache(cm, com.mycompany.myapp.domain.Employee.class.getName() + ".employees");
